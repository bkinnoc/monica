...
// Partials
Vue.component("Avatar", require("./components/partials/Avatar.vue").default);
Vue.component("Confirm", require("./components/partials/Confirm.vue").default);
...
// Contacts
Vue.component("Tags", require("./components/people/Tags.vue").default);
...
Vue.component("ContactTask", require("./components/people/Tasks.vue").default);

Vue.component("ContactNote", require("./components/people/Notes.vue").default);
...
Vue.component("Pet", require("./components/people/Pets.vue").default);
...
Vue.component("Genders", require("./components/settings/Genders.vue").default);
Vue.component(
  "ReminderRules",
...
Vue.component("Modules", require("./components/settings/Modules.vue").default);
Vue.component(
  "ActivityTypes",
...
common
  .loadLanguage((window.Laravel || {}).locale || "en", true)
  .then((i18n) => {
