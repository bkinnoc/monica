...
@section('content')
    <div class="dashboard">
            ...
            <div class="mw9 center">
                <div class="{{ htmldir() == 'ltr' ? 'fl' : 'fr' }} w-70-ns ph2">
                    ...
                    <div class="h3 overflow-hidden mb2">
                        <div class="{{ htmldir() == 'ltr' ? 'fl' : 'fr' }} pr2 dn dib-ns v-mid h3"
                ...
                <div class="{{ htmldir() == 'ltr' ? 'fl-ns tr' : 'fr-ns tl' }} w-30-ns ph2">
                    <a href="{{ route('people.create') }}" class="btn btn-primary w-100 w-auto-ns tc"
        ...
        @if (Auth::user()->charities()->count() == 0)
                ...
                <div class="{{ htmldir() == 'ltr' ? 'fl' : 'fr' }} w-50-ns w-100 pa2">
                    <div class="br3 ba b--gray-monica bg-white mb4">
                        ...
                        <div class="pt3 pr3 pl3 mb4">
                            @include('dashboard._monthReminder', [
                                'reminderOutboxesList' => $reminderOutboxes,
                            ])
                        </div>
                    </div>
                </div>
