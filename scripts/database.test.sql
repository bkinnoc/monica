...
CREATE TABLE `accounts` (
    ...
    CONSTRAINT `accounts_default_gender_id_foreign` FOREIGN KEY (`default_gender_id`) REFERENCES `genders` (`id`) ON DELETE
    SET
        NULL
...
CREATE TABLE `activities` (
    ...
    CONSTRAINT `activities_activity_type_id_foreign` FOREIGN KEY (`activity_type_id`) REFERENCES `activity_types` (`id`) ON DELETE
    SET
        NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE `address_contact_field_label` (
    ...
    `account_id` int unsigned NOT NULL,
    KEY `address_contact_field_label_index` (
        `contact_field_label_id`,
        `address_id`,
        `account_id`
    ),
...
CREATE TABLE `audit_logs` (
    ...
    CONSTRAINT `audit_logs_about_contact_id_foreign` FOREIGN KEY (`about_contact_id`) REFERENCES `contacts` (`id`) ON DELETE
    SET
        NULL,
        CONSTRAINT `audit_logs_account_id_foreign` FOREIGN KEY (`account_id`) REFERENCES `accounts` (`id`) ON DELETE CASCADE,
        CONSTRAINT `audit_logs_author_id_foreign` FOREIGN KEY (`author_id`) REFERENCES `users` (`id`) ON DELETE
    SET
        NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE `contact_field_contact_field_label` (
    ...
    `account_id` int unsigned NOT NULL,
    KEY `contact_field_contact_field_label_index` (
        `contact_field_label_id`,
        `contact_field_id`,
        `account_id`
    ),
...
CREATE TABLE `contacts` (
    ...
    CONSTRAINT `contacts_avatar_photo_id_foreign` FOREIGN KEY (`avatar_photo_id`) REFERENCES `photos` (`id`) ON DELETE
    SET
        NULL,
        CONSTRAINT `contacts_birthday_reminder_id_foreign` FOREIGN KEY (`birthday_reminder_id`) REFERENCES `reminders` (`id`) ON DELETE
    SET
        NULL,
        CONSTRAINT `contacts_birthday_special_date_id_foreign` FOREIGN KEY (`birthday_special_date_id`) REFERENCES `special_dates` (`id`) ON DELETE
    SET
        NULL,
        CONSTRAINT `contacts_deceased_reminder_id_foreign` FOREIGN KEY (`deceased_reminder_id`) REFERENCES `reminders` (`id`) ON DELETE
    SET
        NULL,
        CONSTRAINT `contacts_deceased_special_date_id_foreign` FOREIGN KEY (`deceased_special_date_id`) REFERENCES `special_dates` (`id`) ON DELETE
    SET
        NULL,
        CONSTRAINT `contacts_first_met_reminder_id_foreign` FOREIGN KEY (`first_met_reminder_id`) REFERENCES `reminders` (`id`) ON DELETE
    SET
        NULL,
        CONSTRAINT `contacts_first_met_special_date_id_foreign` FOREIGN KEY (`first_met_special_date_id`) REFERENCES `special_dates` (`id`) ON DELETE
    SET
        NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
INSERT INTO
    `currencies`
VALUES
    (1, 'CAD', 'Canadian Dollar', '$', NULL, NULL),
(2, 'USD', 'US Dollar', '$', NULL, NULL),
(3, 'GBP', 'British Pound', '£', NULL, NULL),
(4, 'EUR', 'Euro', '€', NULL, NULL),
(5, 'RUB', 'Russian Ruble', '₽', NULL, NULL),
(6, 'ZAR', 'South African Rand', 'R ', NULL, NULL),
(7, 'DKK', 'Danish krone', 'kr.', NULL, NULL),
(8, 'INR', 'Indian rupee', '₹', NULL, NULL),
(9, 'BRL', 'Brazilian Real', 'R$', NULL, NULL),
(10, 'CHF', 'Swiss CHF', 'CHF', NULL, NULL),
(11, 'AED', 'Emirati Dirham', '.د.ب', NULL, NULL),
(12, 'AFN', 'Afghan Afghani', '؋', NULL, NULL),
(13, 'ALL', 'Albanian lek', 'lek', NULL, NULL),
(14, 'AMD', 'Armenian dram', '', NULL, NULL),
(15, 'ANG', 'Dutch Guilder', 'ƒ', NULL, NULL),
(16, 'AOA', 'Angolan Kwanza', 'Kz', NULL, NULL),
(17, 'ARS', 'Argentine peso', '$', NULL, NULL),
(18, 'AUD', 'Australian Dollar', '$', NULL, NULL),
(19, 'AWG', 'Arubin florin', 'ƒ', NULL, NULL),
(20, 'AZN', 'Azerbaijani manat', 'ман', NULL, NULL),
(
        21,
        'BAM',
...
(22, 'BBD', 'Barbadian dollar', '$', NULL, NULL),
(23, 'BDT', 'Bangladeshi Taka', 'Tk', NULL, NULL),
(24, 'BGN', 'Bulgarian lev', 'лв', NULL, NULL),
(25, 'BHD', 'Bahraini Dinar', '.د.ب or BD', NULL, NULL),
(26, 'BIF', 'Burundian Franc', '', NULL, NULL),
(27, 'BMD', 'Bermudian dollar', '$', NULL, NULL),
(28, 'BND', 'Bruneian Dollar', '$', NULL, NULL),
(29, 'BOB', 'Bolivian Boliviano', '$b', NULL, NULL),
(30, 'BSD', 'Bahamian dollar', 'B$', NULL, NULL),
(31, 'BTN', 'Bhutanese Ngultrum', 'Nu.', NULL, NULL),
(32, 'BWP', 'Botswana Pula', 'P', NULL, NULL),
(33, 'BYR', 'Belarusian ruble', 'р', NULL, NULL),
(34, 'BZD', 'Belize dollar', 'BZ$', NULL, NULL),
(35, 'CLP', 'Chilean Peso', '$', NULL, NULL),
(
        36,
        'CNY',
...
(37, 'COP', 'Colombian peso', '$', NULL, NULL),
(38, 'CRC', 'Costa Rican colón', '₡', NULL, NULL),
(39, 'CUC', 'Cuban convertible peso', '$', NULL, NULL),
(40, 'CUP', 'Cuban peso', '₱', NULL, NULL),
(41, 'CVE', 'Cape Verdean Escudo', '$', NULL, NULL),
(42, 'CZK', 'Czech koruna', 'Kč', NULL, NULL),
(43, 'DJF', 'Djiboutian Franc', 'fdj', NULL, NULL),
(44, 'DOP', 'Dominican peso', '$', NULL, NULL),
(45, 'DZD', 'Algerian Dinar', 'جد', NULL, NULL),
(46, 'EGP', 'Egyptian Pound', '£ ', NULL, NULL),
(47, 'ERN', 'Eritrean nakfa', 'ናቕፋ', NULL, NULL),
(48, 'ETB', 'Ethiopian Birr', 'Br', NULL, NULL),
(49, 'FJD', 'Fijian dollar', '$', NULL, NULL),
(50, 'FKP', 'Falkland Island Pound', '£', NULL, NULL),
(51, 'GEL', 'Georgian lari', 'ლ', NULL, NULL),
(52, 'GHS', 'Ghanaian Cedi', 'GH¢', NULL, NULL),
(53, 'GIP', 'Gibraltar pound', '£', NULL, NULL),
(54, 'GMD', 'Gambian dalasi', '', NULL, NULL),
(55, 'GNF', 'Guinean Franc', '', NULL, NULL),
(56, 'GTQ', 'Guatemalan Quetzal', 'Q', NULL, NULL),
(57, 'GYD', 'Guyanese dollar', '$', NULL, NULL),
(58, 'HKD', 'Hong Kong dollar', 'HK$', NULL, NULL),
(59, 'HNL', 'Honduran lempira', 'L', NULL, NULL),
(60, 'HRK', 'Croatian kuna', 'kn', NULL, NULL),
(61, 'HTG', 'Haitian gourde', 'G', NULL, NULL),
(62, 'HUF', 'Hungarian forint', 'Ft', NULL, NULL),
(63, 'IDR', 'Indonesian Rupiah', 'Rp', NULL, NULL),
(64, 'ILS', 'Israeli Shekel', '₪', NULL, NULL),
(65, 'IQD', 'Iraqi Dinar', 'ع.د', NULL, NULL),
(66, 'IRR', 'Iranian Rial', '', NULL, NULL),
(67, 'ISK', 'Icelandic Krona', 'kr', NULL, NULL),
(68, 'JMD', 'Jamaican dollar', 'J$', NULL, NULL),
(69, 'JOD', 'Jordanian Dinar', '', NULL, NULL),
(70, 'JPY', 'Japanese yen', '¥', NULL, NULL),
(71, 'KES', 'Kenyan Shilling', 'KSh', NULL, NULL),
(72, 'KGS', 'Kyrgyzstani som', 'лв', NULL, NULL),
(73, 'KHR', 'Cambodian Riel', '៛', NULL, NULL),
(74, 'KMF', 'Comoran Franc', '', NULL, NULL),
(75, 'KPW', 'North Korean won', '₩', NULL, NULL),
(76, 'KRW', 'South Korean won', '₩', NULL, NULL),
(77, 'KWD', 'Kuwaiti Dinar', 'ك', NULL, NULL),
(78, 'KYD', 'Caymanian Dollar', '$', NULL, NULL),
(79, 'KZT', 'Kazakhstani tenge', '₸', NULL, NULL),
(80, 'LAK', 'Lao or Laotian Kip', '₭', NULL, NULL),
(81, 'LBP', 'Lebanese Pound', 'ل.ل', NULL, NULL),
(82, 'LKR', 'Sri Lankan Rupee', 'Rs', NULL, NULL),
(83, 'LRD', 'Liberian Dollar', '$', NULL, NULL),
(84, 'LSL', 'Lesotho loti', 'L or M', NULL, NULL),
(85, 'LTL', 'Lithuanian litas', 'Lt', NULL, NULL),
(86, 'LYD', 'Libyan Dinar', ' د.ل', NULL, NULL),
(87, 'MAD', 'Moroccan Dirham', 'م.د.', NULL, NULL),
(88, 'MDL', 'Moldovan Leu', 'L', NULL, NULL),
(89, 'MGA', 'Malagasy Ariary', 'Ar', NULL, NULL),
(90, 'MKD', 'Macedonian Denar', 'ден', NULL, NULL),
(91, 'MMK', 'Burmese Kyat', 'K', NULL, NULL),
(92, 'MNT', 'Mongolian Tughrik', '₮', NULL, NULL),
(93, 'MOP', 'Macau Pataca', 'MOP$', NULL, NULL),
(94, 'MRO', 'Mauritanian Ouguiya', 'UM', NULL, NULL),
(95, 'MUR', 'Mauritian rupee', 'Rs', NULL, NULL),
(96, 'MVR', 'Maldivian Rufiyaa', 'rf', NULL, NULL),
(97, 'MWK', 'Malawian Kwacha', 'MK', NULL, NULL),
(98, 'MXN', 'Mexico Peso', '$', NULL, NULL),
(99, 'MYR', 'Malaysian Ringgit', 'RM', NULL, NULL),
(100, 'MZN', 'Mozambican Metical', 'MT', NULL, NULL),
(101, 'NAD', 'Namibian Dollar', '$', NULL, NULL),
(102, 'NGN', 'Nigerian Naira', '₦', NULL, NULL),
(103, 'NIO', 'Nicaraguan córdoba', 'C$', NULL, NULL),
(104, 'NOK', 'Norwegian krone', 'kr', NULL, NULL),
(105, 'NPR', 'Nepalese Rupee', 'Rs', NULL, NULL),
(106, 'NZD', 'New Zealand Dollar', '$', NULL, NULL),
(107, 'OMR', 'Omani Rial', 'ع.ر.', NULL, NULL),
(108, 'PAB', 'Balboa panamérn', 'B/', NULL, NULL),
(109, 'PEN', 'Peruvian nuevo sol', 'S/', NULL, NULL),
(110, 'PGK', 'Papua New Guinean Kina', 'K', NULL, NULL),
(111, 'PHP', 'Philippine Peso', '₱', NULL, NULL),
(112, 'PKR', 'Pakistani Rupee', 'Rs', NULL, NULL),
(113, 'PLN', 'Polish złoty', 'zł', NULL, NULL),
(114, 'PYG', 'Paraguayan guarani', '₲', NULL, NULL),
(115, 'QAR', 'Qatari Riyal', 'ق.ر ', NULL, NULL),
(116, 'RON', 'Romanian leu', 'lei', NULL, NULL),
(117, 'RSD', 'Serbian Dinar', 'РСД', NULL, NULL),
(
        118,
        'RWF',
        'Rwandan franc',
...
(119, 'SAR', 'Saudi Arabian Riyal', 'ر.س', NULL, NULL),
(
        120,
        'SBD',
...
(121, 'SCR', 'Seychellois Rupee', 'Rs', NULL, NULL),
(122, 'SDG', 'Sudanese Pound', '', NULL, NULL),
(123, 'SEK', 'Swedish krona', 'kr', NULL, NULL),
(124, 'SGD', 'Singapore Dollar', '$', NULL, NULL),
(125, 'SLL', 'Sierra Leonean Leone', 'Le', NULL, NULL),
(126, 'SOS', 'Somali Shilling', 'S', NULL, NULL),
(127, 'SRD', 'Surinamese dollar', '$', NULL, NULL),
(128, 'SSP', 'South Sudanese pound', '£', NULL, NULL),
(129, 'SYP', 'Syrian Pound', '£', NULL, NULL),
(130, 'SZL', 'Swazi Lilangeni', 'L or E', NULL, NULL),
(131, 'THB', 'Thai Baht', '฿', NULL, NULL),
(132, 'TJS', 'Tajikistani somoni', '', NULL, NULL),
(133, 'TMT', 'Turkmenistan manat', 'T', NULL, NULL),
(134, 'TND', 'Tunisian Dinar', '', NULL, NULL),
(135, 'TOP', 'Tongan Pa\'anga', 'T$', NULL, NULL),
(136, 'TRY', 'Turkish Lira', '', NULL, NULL),
(137, 'TTD', 'Trinidadian dollar', 'TT$', NULL, NULL),
(138, 'TWD', 'Taiwan New Dollar', 'NT$', NULL, NULL),
(139, 'TZS', 'Tanzanian Shilling', 'Sh', NULL, NULL),
(140, 'UAH', 'Ukrainian Hryvnia', '₴', NULL, NULL),
(141, 'UGX', 'Ugandan Shilling', 'USh', NULL, NULL),
(142, 'UYU', 'Uruguayan peso', '$U', NULL, NULL),
(143, 'UZS', 'Uzbekistani som', 'лв', NULL, NULL),
(144, 'VEF', 'Venezuelan bolivar', 'Bs', NULL, NULL),
(145, 'VND', 'Vietnamese Dong', '₫', NULL, NULL),
(146, 'VUV', 'Ni-Vanuatu Vatu', 'VT', NULL, NULL),
(147, 'WST', 'Samoan Tālā', '$', NULL, NULL),
(
        148,
        'XCD',
...
(149, 'XOF', 'CFA Franc', '', NULL, NULL),
(150, 'XPF', 'CFP Franc', '', NULL, NULL),
(151, 'YER', 'Yemeni Rial', '', NULL, NULL),
(152, 'ZMW', 'Zambian Kwacha', 'ZMK', NULL, NULL),
(153, 'ZWD', 'Zimbabwean Dollar', 'Z$', NULL, NULL);
...
CREATE TABLE `debts` (
    ...
    CONSTRAINT `debts_currency_id_foreign` FOREIGN KEY (`currency_id`) REFERENCES `currencies` (`id`) ON DELETE
    SET
        NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
VALUES
    (
        1,
        'love_relationships',
        'app.relationship_type_group_love',
        0,
        1,
        1,
        NULL,
...
(
        ...
        'app.relationship_type_group_family',
        0,
        1,
        1,
        NULL,
...
(
        3,
        'other_relationships',
        'app.relationship_type_group_other',
        0,
        1,
        1,
        NULL,
...
(4, 'pets', 'people.pets_title', 0, 1, 1, NULL, NULL),
(
        5,
        'contact_information',
        'people.section_contact_information',
        0,
        1,
        1,
        NULL,
...
(
        7,
        'how_you_met',
        'people.introductions_sidebar_title',
        0,
        1,
        1,
        NULL,
...
(
        13,
        'reminders',
        'people.section_personal_reminders',
        0,
        1,
        1,
        NULL,
...
(15, 'gifts', 'people.gifts_title', 0, 1, 1, NULL, NULL),
(16, 'debts', 'people.debt_title', 0, 1, 1, NULL, NULL),
(
        17,
        'conversations',
        'people.conversation_list_title',
        0,
        1,
        1,
        NULL,
...
VALUES
    (
        ...
        1,
        'new_job',
        '{\"employer\": {\"type\": \"string\", \"value\": \"\"}, \"job_title\": {\"type\": \"string\", \"value\": \"\"}}',
        0,
        '2020-05-21 19:15:22',
        '2020-05-21 19:15:22'
    ),
...
(
        ...
        1,
        'new_school',
        '{\"degree\": {\"type\": \"string\", \"value\": \"\"}, \"end_date\": {\"type\": \"date\", \"value\": \"\"}, \"end_date_reminder_id\": {\"type\": \"integer\", \"value\": \"\"}, \"school_name\": {\"type\": \"string\", \"value\": \"\"}, \"studying\": {\"type\": \"string\", \"value\": \"\"}}',
        0,
        '2020-05-21 19:15:22',
        '2020-05-21 19:15:22'
    ),
...
(
        6,
        1,
        'published_book_or_paper',
        '{\"full_citation\": {\"type\": \"string\", \"value\": \"\"}, \"url\": {\"type\": \"string\", \"value\": \"\"}, \"citation\": {\"type\": \"string\", \"value\": \"\"}}',
        0,
        '2020-05-21 19:15:22',
        '2020-05-21 19:15:22'
    ),
(
        ...
        1,
        'military_service',
        '{\"end_date\": {\"type\": \"date\", \"value\": \"\"}, \"end_date_reminder_id\": {\"type\": \"integer\", \"value\": \"\"}, \"branch\": {\"type\": \"string\", \"value\": \"\"}, \"division\": {\"type\": \"string\", \"value\": \"\"}, \"country\": {\"type\": \"string\", \"value\": \"\"}}',
        0,
        '2020-05-21 19:15:22',
        '2020-05-21 19:15:22'
    ),
...
(
        ...
        2,
        'engagement',
        '{\"with_contact_id\": {\"type\": \"integer\", \"value\": \"\"}}',
        0,
        '2020-05-21 19:15:22',
        '2020-05-21 19:15:22'
    ),
...
(
        ...
        2,
        'expecting_a_baby',
        '{\"contact_id\": {\"type\": \"integer\", \"value\": \"\"}, \"expected_date\": {\"type\": \"date\", \"value\": \"\"}, \"expected_date_reminder_id\": {\"type\": \"integer\", \"value\": \"\"}, \"expected_gender\": {\"type\": \"string\", \"value\": \"\"}}',
        0,
        '2020-05-21 19:15:22',
        '2020-05-21 19:15:22'
    ),
...
(
        ...
        2,
        'end_of_relationship',
        '{\"breakup_reason\": {\"type\": \"string\", \"value\": \"\"}, \"who_broke_up_contact_id\": {\"type\": \"integer\", \"value\": \"\"}}',
        0,
        '2020-05-21 19:15:22',
        '2020-05-21 19:15:22'
    ),
...
(
        ...
        3,
        'bought_a_home',
        '{\"address\": {\"type\": \"string\", \"value\": \"\"}, \"estimated_value\": {\"type\": \"number\", \"value\": \"\"}}',
        0,
        '2020-05-21 19:15:22',
        '2020-05-21 19:15:22'
    ),
...
(
        ...
        3,
        'holidays',
        '{\"where\": {\"type\": \"string\", \"value\": \"\"}, \"duration_in_days\": {\"type\": \"integer\", \"value\": \"\"}}',
        0,
        '2020-05-21 19:15:22',
        '2020-05-21 19:15:22'
    ),
(
        ...
        3,
        'new_vehicle',
        '{\"type\": {\"type\": \"string\", \"value\": \"\"}, \"model\": {\"type\": \"string\", \"value\": \"\"}, \"model_year\": {\"type\": \"string\", \"value\": \"\"}}',
        0,
        '2020-05-21 19:15:22',
        '2020-05-21 19:15:22'
    ),
...
(
        ...
        4,
        'weight_loss',
        '{\"amount\": {\"type\": \"string\", \"value\": \"\"}, \"unit\": {\"type\": \"string\", \"value\": \"\"}}',
        0,
        '2020-05-21 19:15:22',
        '2020-05-21 19:15:22'
    ),
...
(
        ...
        4,
        'surgery',
        '{\"nature\": {\"type\": \"string\", \"value\": \"\"}, \"number_days_in_hospital\": {\"type\": \"integer\", \"value\": \"\"}, \"number_days_in_hospital\": {\"type\": \"integer\", \"value\": \"\"}, \"expected_date_out_of_hospital_reminder_id\": {\"type\": \"integer\", \"value\": \"\"}}',
        0,
        '2020-05-21 19:15:22',
        '2020-05-21 19:15:22'
    ),
...
(
        ...
        5,
        'travel',
        '{\"visited_place\": {\"type\": \"string\", \"value\": \"\"}, \"duration_in_days\": {\"type\": \"integer\", \"value\": \"\"}}',
        0,
        '2020-05-21 19:15:23',
        '2020-05-21 19:15:23'
    ),
...
VALUES
    (1, 'love', 0, 1, NULL, NULL),
(2, 'family', 0, 1, NULL, NULL),
(3, 'friend', 0, 1, NULL, NULL),
(4, 'work', 0, 1, NULL, NULL);
...
VALUES
    (1, 'partner', 'partner', 1, 0, 1, NULL, NULL),
(2, 'spouse', 'spouse', 1, 0, 1, NULL, NULL),
(3, 'date', 'date', 1, 0, 1, NULL, NULL),
(4, 'lover', 'lover', 1, 0, 1, NULL, NULL),
(5, 'inlovewith', 'lovedby', 1, 0, 1, NULL, NULL),
(6, 'lovedby', 'inlovewith', 1, 0, 1, NULL, NULL),
(7, 'ex', 'ex', 1, 0, 1, NULL, NULL),
(8, 'parent', 'child', 2, 0, 1, NULL, NULL),
(9, 'child', 'parent', 2, 0, 1, NULL, NULL),
(10, 'sibling', 'sibling', 2, 0, 1, NULL, NULL),
(11, 'grandparent', 'grandchild', 2, 0, 1, NULL, NULL),
(12, 'grandchild', 'grandparent', 2, 0, 1, NULL, NULL),
(13, 'uncle', 'nephew', 2, 0, 1, NULL, NULL),
(14, 'nephew', 'uncle', 2, 0, 1, NULL, NULL),
(15, 'cousin', 'cousin', 2, 0, 1, NULL, NULL),
(16, 'godfather', 'godson', 2, 0, 1, NULL, NULL),
(17, 'godson', 'godfather', 2, 0, 1, NULL, NULL),
(18, 'friend', 'friend', 3, 0, 1, NULL, NULL),
(19, 'bestfriend', 'bestfriend', 3, 0, 1, NULL, NULL),
(20, 'colleague', 'colleague', 4, 0, 1, NULL, NULL),
(21, 'boss', 'subordinate', 4, 0, 1, NULL, NULL),
(22, 'subordinate', 'boss', 4, 0, 1, NULL, NULL),
(23, 'mentor', 'protege', 4, 0, 1, NULL, NULL),
(24, 'protege', 'mentor', 4, 0, 1, NULL, NULL),
(25, 'ex_husband', 'ex_husband', 1, 0, 1, NULL, NULL),
(26, 'stepparent', 'stepchild', 2, 0, 1, NULL, NULL),
(27, 'stepchild', 'stepparent', 2, 0, 1, NULL, NULL);
...
INSERT INTO
    `emotions`
VALUES
    (1, 1, 1, 'adoration', NULL, NULL),
(2, 1, 1, 'affection', NULL, NULL),
(3, 1, 1, 'love', NULL, NULL),
(4, 1, 1, 'fondness', NULL, NULL),
(5, 1, 1, 'liking', NULL, NULL),
(6, 1, 1, 'attraction', NULL, NULL),
(7, 1, 1, 'caring', NULL, NULL),
(8, 1, 1, 'tenderness', NULL, NULL),
(9, 1, 1, 'compassion', NULL, NULL),
(10, 1, 1, 'sentimentality', NULL, NULL),
(11, 1, 2, 'arousal', NULL, NULL),
(12, 1, 2, 'desire', NULL, NULL),
(13, 1, 2, 'lust', NULL, NULL),
(14, 1, 2, 'passion', NULL, NULL),
(15, 1, 2, 'infatuation', NULL, NULL),
(16, 1, 3, 'longing', NULL, NULL),
(17, 2, 4, 'amusement', NULL, NULL),
(18, 2, 4, 'bliss', NULL, NULL),
(19, 2, 4, 'cheerfulness', NULL, NULL),
(20, 2, 4, 'gaiety', NULL, NULL),
(21, 2, 4, 'glee', NULL, NULL),
(22, 2, 4, 'jolliness', NULL, NULL),
(23, 2, 4, 'joviality', NULL, NULL),
(24, 2, 4, 'joy', NULL, NULL),
(25, 2, 4, 'delight', NULL, NULL),
(26, 2, 4, 'enjoyment', NULL, NULL),
(27, 2, 4, 'gladness', NULL, NULL),
(28, 2, 4, 'happiness', NULL, NULL),
(29, 2, 4, 'jubilation', NULL, NULL),
(30, 2, 4, 'elation', NULL, NULL),
(31, 2, 4, 'satisfaction', NULL, NULL),
(32, 2, 4, 'ecstasy', NULL, NULL),
(33, 2, 4, 'euphoria', NULL, NULL),
(34, 2, 5, 'enthusiasm', NULL, NULL),
(35, 2, 5, 'zeal', NULL, NULL),
(36, 2, 5, 'zest', NULL, NULL),
(37, 2, 5, 'excitement', NULL, NULL),
(38, 2, 5, 'thrill', NULL, NULL),
(39, 2, 5, 'exhilaration', NULL, NULL),
(40, 2, 6, 'contentment', NULL, NULL),
(41, 2, 6, 'pleasure', NULL, NULL),
(42, 2, 7, 'pride', NULL, NULL),
(43, 2, 7, 'pleasure', NULL, NULL),
(44, 2, 8, 'eagerness', NULL, NULL),
(45, 2, 8, 'hope', NULL, NULL),
(46, 2, 9, 'enthrallment', NULL, NULL),
(47, 2, 9, 'rapture', NULL, NULL),
(48, 2, 10, 'relief', NULL, NULL),
(49, 3, 11, 'amazement', NULL, NULL),
(50, 3, 11, 'surprise', NULL, NULL),
(51, 3, 11, 'astonishment', NULL, NULL),
(52, 4, 12, 'aggravation', NULL, NULL),
(53, 4, 12, 'irritation', NULL, NULL),
(54, 4, 12, 'agitation', NULL, NULL),
(55, 4, 12, 'annoyance', NULL, NULL),
(56, 4, 12, 'grouchiness', NULL, NULL),
(57, 4, 12, 'grumpiness', NULL, NULL),
(58, 4, 13, 'exasperation', NULL, NULL),
(59, 4, 13, 'frustration', NULL, NULL),
(60, 4, 14, 'anger', NULL, NULL),
(61, 4, 14, 'rage', NULL, NULL),
(62, 4, 14, 'outrage', NULL, NULL),
(63, 4, 14, 'fury', NULL, NULL),
(64, 4, 14, 'wrath', NULL, NULL),
(65, 4, 14, 'hostility', NULL, NULL),
(66, 4, 14, 'ferocity', NULL, NULL),
(67, 4, 14, 'bitterness', NULL, NULL),
(68, 4, 14, 'hate', NULL, NULL),
(69, 4, 14, 'loathing', NULL, NULL),
(70, 4, 14, 'scorn', NULL, NULL),
(71, 4, 14, 'spite', NULL, NULL),
(72, 4, 14, 'vengefulness', NULL, NULL),
(73, 4, 14, 'dislike', NULL, NULL),
(74, 4, 14, 'resentment', NULL, NULL),
(75, 4, 15, 'disgust', NULL, NULL),
(76, 4, 15, 'revulsion', NULL, NULL),
(77, 4, 15, 'contempt', NULL, NULL),
(78, 4, 16, 'envy', NULL, NULL),
(79, 4, 16, 'jealousy', NULL, NULL),
(80, 5, 17, 'agony', NULL, NULL),
(81, 5, 17, 'suffering', NULL, NULL),
(82, 5, 17, 'hurt', NULL, NULL),
(83, 5, 17, 'anguish', NULL, NULL),
(84, 5, 18, 'depression', NULL, NULL),
(85, 5, 18, 'despair', NULL, NULL),
(86, 5, 18, 'hopelessness', NULL, NULL),
(87, 5, 18, 'gloom', NULL, NULL),
(88, 5, 18, 'glumness', NULL, NULL),
(89, 5, 18, 'sadness', NULL, NULL),
(90, 5, 18, 'unhappiness', NULL, NULL),
(91, 5, 18, 'grief', NULL, NULL),
(92, 5, 18, 'sorrow', NULL, NULL),
(93, 5, 18, 'woe', NULL, NULL),
(94, 5, 18, 'misery', NULL, NULL),
(95, 5, 18, 'melancholy', NULL, NULL),
(96, 5, 19, 'dismay', NULL, NULL),
(97, 5, 19, 'disappointment', NULL, NULL),
(98, 5, 19, 'displeasure', NULL, NULL),
(99, 5, 20, 'guilt', NULL, NULL),
(100, 5, 20, 'shame', NULL, NULL),
(101, 5, 20, 'regret', NULL, NULL),
(102, 5, 20, 'remorse', NULL, NULL),
(103, 5, 21, 'alienation', NULL, NULL),
(104, 5, 21, 'isolation', NULL, NULL),
(105, 5, 21, 'neglect', NULL, NULL),
(106, 5, 21, 'loneliness', NULL, NULL),
(107, 5, 21, 'rejection', NULL, NULL),
(108, 5, 21, 'homesickness', NULL, NULL),
(109, 5, 21, 'defeat', NULL, NULL),
(110, 5, 21, 'dejection', NULL, NULL),
(111, 5, 21, 'insecurity', NULL, NULL),
(112, 5, 21, 'embarrassment', NULL, NULL),
(113, 5, 21, 'humiliation', NULL, NULL),
(114, 5, 21, 'insult', NULL, NULL),
(115, 5, 22, 'pity', NULL, NULL),
(116, 5, 22, 'sympathy', NULL, NULL),
(117, 6, 23, 'alarm', NULL, NULL),
(118, 6, 23, 'shock', NULL, NULL),
(119, 6, 23, 'fear', NULL, NULL),
(120, 6, 23, 'fright', NULL, NULL),
(121, 6, 23, 'horror', NULL, NULL),
(122, 6, 23, 'terror', NULL, NULL),
(123, 6, 23, 'panic', NULL, NULL),
(124, 6, 23, 'hysteria', NULL, NULL),
(125, 6, 23, 'mortification', NULL, NULL),
(126, 6, 24, 'anxiety', NULL, NULL),
(127, 6, 24, 'nervousness', NULL, NULL),
(128, 6, 24, 'tenseness', NULL, NULL),
(129, 6, 24, 'uneasiness', NULL, NULL),
(130, 6, 24, 'apprehension', NULL, NULL),
(131, 6, 24, 'worry', NULL, NULL),
(132, 6, 24, 'distress', NULL, NULL),
(133, 6, 24, 'dread', NULL, NULL);
...
INSERT INTO
    `emotions_secondary`
VALUES
    (1, 1, 'affection', NULL, NULL),
(2, 1, 'lust', NULL, NULL),
(3, 1, 'longing', NULL, NULL),
(4, 2, 'cheerfulness', NULL, NULL),
(5, 2, 'zest', NULL, NULL),
(6, 2, 'contentment', NULL, NULL),
(7, 2, 'pride', NULL, NULL),
(8, 2, 'optimism', NULL, NULL),
(9, 2, 'enthrallment', NULL, NULL),
(10, 2, 'relief', NULL, NULL),
(11, 3, 'surprise', NULL, NULL),
(12, 4, 'irritation', NULL, NULL),
(13, 4, 'exasperation', NULL, NULL),
(14, 4, 'rage', NULL, NULL),
(15, 4, 'disgust', NULL, NULL),
(16, 4, 'envy', NULL, NULL),
(17, 5, 'suffering', NULL, NULL),
(18, 5, 'sadness', NULL, NULL),
(19, 5, 'disappointment', NULL, NULL),
(20, 5, 'shame', NULL, NULL),
(21, 5, 'neglect', NULL, NULL),
(22, 5, 'sympathy', NULL, NULL),
(23, 6, 'horror', NULL, NULL),
(24, 6, 'nervousness', NULL, NULL);
...
CREATE TABLE `gifts` (
    ...
    CONSTRAINT `gifts_currency_id_foreign` FOREIGN KEY (`currency_id`) REFERENCES `currencies` (`id`) ON DELETE
    SET
        NULL,
        CONSTRAINT `gifts_is_for_foreign` FOREIGN KEY (`is_for`) REFERENCES `contacts` (`id`) ON DELETE
    SET
        NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE `life_events` (
    ...
    CONSTRAINT `life_events_reminder_id_foreign` FOREIGN KEY (`reminder_id`) REFERENCES `reminders` (`id`) ON DELETE
    SET
        NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
(8, '2016_06_07_234741_create_account_table', 1),
(9, '2016_06_08_003006_add_account_info_table', 1),
(10, '2016_06_08_005413_create_contacts_table', 1),
(
        11,
        '2016_06_25_224219_create_reminder_type_table',
        1
    ),
(12, '2016_06_28_191025_create_tasks_table', 1),
(13, '2016_06_30_185050_create_notes_table', 1),
(14, '2016_07_25_133835_add_width_field', 1),
(15, '2016_08_28_122938_create_kids_table', 1),
(16, '2016_08_28_215159_create_relations_table', 1),
(
        17,
        '2016_09_03_202027_add_reminder_id_to_contacts',
        1
    ),
(
        18,
        '2016_09_05_134937_add_last_talked_to_field',
        1
    ),
(
        19,
        '2016_09_05_135927_add_people_id_to_contacts',
        1
    ),
(
        20,
        '2016_09_05_145111_add_name_info_to_peoples',
        1
    ),
(
        21,
        '2016_09_06_213550_create_activity_type_table',
        1
    ),
(22, '2016_09_10_164406_create_jobs_table', 1),
(
        23,
        '2016_09_10_170122_create_notifications_table',
        1
    ),
(
        24,
        '2016_09_12_014120_create_failed_jobs_table',
        1
    ),
(25, '2016_09_30_014720_add_kid_to_reminder', 1),
(26, '2016_10_15_024156_add_deleted_at_to_users', 1),
(27, '2016_10_19_155139_create_cache_table', 1),
(28, '2016_10_19_155800_create_sessions_table', 1),
(29, '2016_10_21_022941_add_statistics_table', 1),
(
        30,
        '2016_10_24_013543_add_journal_setting_to_users',
        1
    ),
(31, '2016_10_24_014257_create_journal_tables', 1),
(32, '2016_10_28_002518_add_metric_to_settings', 1),
(33, '2016_11_01_014353_create_activities_table', 1),
(34, '2016_11_01_015957_add_icon_column', 1),
(
        35,
        '2016_11_03_150307_add_activity_location_to_activities',
        1
    ),
(36, '2016_11_09_013049_add_events_table', 1),
(37, '2016_12_08_011555_remove_type_from_notes', 1),
(38, '2016_12_13_133945_add_gifts_table', 1),
(39, '2016_12_28_150831_change_title_column', 1),
(
        40,
        '2017_01_14_200815_add_facebook_columns_to_users_table',
        1
    ),
(41, '2017_01_15_045025_add_colors_to_users', 1),
(42, '2017_01_22_142645_add_fields_to_contacts', 1),
(
        43,
        '2017_01_23_043831_change_people_to_contact_for_kids',
        1
    ),
(
        44,
        '2017_01_26_013524_change_people_to_significantother',
        1
    ),
(45, '2017_01_26_022852_change_notes_to_contact', 1),
(
        46,
        '2017_01_26_034553_add_notes_count_to_contact',
        1
    ),
(47, '2017_01_27_024356_change_people_in_events', 1),
(
        48,
        '2017_01_28_180156_remove_deleted_at_from_significant_others',
        1
    ),
(
        49,
        '2017_01_28_184901_remove_deleted_at_from_kids',
        1
    ),
(
        50,
        '2017_01_28_193913_remove_deleted_at_from_notes',
        1
    ),
(
        51,
        '2017_01_28_222114_remove_viewed_at_from_contacts',
        1
    ),
(
        52,
        '2017_01_29_175146_remove_delete_at_from_activities',
        1
    ),
(
        53,
        '2017_01_29_175629_add_number_activities_to_contacts',
        1
    ),
(
        54,
        '2017_01_31_025849_add_activity_statistics_table',
        1
    ),
(55, '2017_02_02_232450_add_confirmation', 1),
(56, '2017_02_04_225618_change_reminders_table', 1),
(
        57,
        '2017_02_05_035925_add_gifts_metrics_to_contacts',
        1
    ),
(58, '2017_02_05_041740_change_gifts_table', 1),
(
        59,
        '2017_02_05_042122_change_people_to_contact_for_gifts',
        1
    ),
(60, '2017_02_07_041607_change_tasks_table', 1),
(
        61,
        '2017_02_07_051355_add_number_tasks_to_contact',
        1
    ),
(
        62,
        '2017_02_08_002251_change_number_tasks_contact',
        1
    ),
(
        63,
        '2017_02_08_025358_add_sort_preferences_to_users',
        1
    ),
(
        64,
        '2017_02_10_195613_remove_notifications_table',
        1
    ),
(65, '2017_02_10_214714_remove_people_table', 1),
(66, '2017_02_10_215405_remove_entities_table', 1),
(
        67,
        '2017_02_10_215705_remove_deleted_at_from_contact',
        1
    ),
(68, '2017_02_10_224355_calculate_statistics', 1),
(69, '2017_02_11_154900_add_avatars_to_contacts', 1),
(70, '2017_02_12_134220_create_entries_table', 1),
(
        71,
        '2017_05_03_155254_move_significant_other_data',
        1
    ),
(
        72,
        '2017_05_04_164723_remove_contact_encryption',
        1
    ),
(73, '2017_05_04_185921_add_title_to_activities', 1),
(74, '2017_05_04_193252_alter_activity_nullable', 1),
(75, '2017_05_08_164514_remove_encryption_tasks', 1),
(
        76,
        '2017_05_30_002239_remove_predefined_reminders',
        1
    ),
(77, '2017_05_30_023116_create_money_table', 1),
(
        78,
        '2017_06_07_173437_add_multiple_genders_choices',
        1
    ),
(
        79,
        '2017_06_10_152945_add_social_networks_to_contacts',
        1
    ),
(80, '2017_06_10_155349_create_currencies_data', 1),
(
        81,
        '2017_06_11_025227_remove_encryption_journal',
        1
    ),
(
        82,
        '2017_06_11_110735_change_unique_constraint_for_contacts',
        1
    ),
(83, '2017_06_13_035059_remove_gifts_encryption', 1),
(84, '2017_06_13_195740_add_company_to_contacts', 1),
(85, '2017_06_14_131803_remove_bern_timezone', 1),
(
        86,
        '2017_06_14_132911_add_zar_currency_to_currencies_table',
        1
    ),
(
        87,
        '2017_06_16_215256_add_about_who_to_reminders',
        1
    ),
(88, '2017_06_17_010900_fix_contacts_table', 1),
(89, '2017_06_17_153814_refactor_user_table', 1),
(
        90,
        '2017_06_19_105842_add_stripe_fields_to_users',
        1
    ),
(
        91,
        '2017_06_20_121345_add_invitations_statistics',
        1
    ),
(92, '2017_06_22_210813_add_name_order_to_users', 1),
(93, '2017_06_27_134704_create_import_table', 1),
(
        94,
        '2017_06_29_211725_add_import_job_to_statistics',
        1
    ),
(
        95,
        '2017_06_29_230523_add_gravatar_url_to_users',
        1
    ),
(96, '2017_07_02_155736_create_tags_table', 1),
(97, '2017_07_04_132743_add_tags_to_statistics', 1),
(
        98,
        '2017_07_09_164312_update_bad_translation_key',
        1
    ),
(99, '2017_07_12_014244_create_calls_table', 1),
(
        100,
        '2017_07_17_005012_drop_reminders_count_from_contacts',
        1
    ),
(
        101,
...
(
        103,
        '2017_07_19_094503_add_brazilian_real_to_currencies',
        1
    ),
(104, '2017_07_22_153209_create_instance_table', 1),
(105, '2017_07_26_220021_change_contacts_table', 1),
(
        106,
        '2017_08_02_152838_change_string_to_boolean_for_reminders',
        1
    ),
(107, '2017_08_06_085629_change_events_data', 1),
(108, '2017_08_06_153253_move_kids_to_contacts', 1),
(
        109,
...
(
        110,
        '2017_08_21_224835_remove_paid_limitations_for_current_users',
        1
    ),
(
        111,
        '2017_09_10_125918_remove_unusued_counters',
        1
    ),
(112, '2017_09_13_095923_add_tracking_table', 1),
(113, '2017_09_13_191714_add_partial_notion', 1),
(
        114,
        '2017_10_14_083556_change_gift_column_structure',
        1
    ),
(115, '2017_10_17_170803_change_gift_structure', 1),
(
        116,
        '2017_10_19_134816_create_activity_contact_table',
        1
    ),
(
        117,
        '2017_10_19_135215_move_activities_to_pivot_table',
        1
    ),
(
        118,
        '2017_10_25_102923_remove_contact_id_activities_table',
        1
    ),
(
        119,
        '2017_11_01_122541_add_met_through_to_contacts',
        1
    ),
(
        120,
        '2017_11_02_202601_add_is_dead_to_contacts',
        1
    ),
(
        121,
        '2017_11_10_174654_create_contact_fields_table',
        1
    ),
(
        122,
        '2017_11_10_181043_migrate_contacts_information',
        1
    ),
(
        123,
        '2017_11_10_202620_move_addresses_from_contact_to_addresses',
        1
    ),
(
        124,
        '2017_11_10_204035_delete_contact_fields_from_contacts',
        1
    ),
(
        125,
        '2017_11_20_115635_change-amount-to-double-on-debts',
        1
    ),
(126, '2017_11_27_083043_add_more_statistics', 1),
(
        127,
        '2017_11_27_134403_add_new_avatar_to_contacts',
        1
    ),
(
        128,
        '2017_11_27_202857_change_tasks_table_structure',
        1
    ),
(129, '2017_12_01_113748_update_notes', 1),
(130, '2017_12_04_164831_create_ages_table', 1),
(131, '2017_12_04_165421_move_ages_data', 1),
(
        132,
...
(
        133,
        '2017_12_10_205328_add_account_id_to_activities',
        1
    ),
(
        134,
        '2017_12_10_214545_add_last_consulted_at_to_contacts',
        1
    ),
(135, '2017_12_13_115857_create_day_table', 1),
(
        136,
        '2017_12_21_163616_update_journal_entries_with_existing_activities',
        1
    ),
(
        137,
        '2017_12_21_170327_add_google2fa_secret_to_users',
        1
    ),
(138, '2017_12_24_115641_create_pets_table', 1),
(
        139,
        '2017_12_31_114224_add_dashboard_tab_to_users',
        1
    ),
(
        140,
        '2018_01_15_105858_create_additional_reminders_table',
        1
    ),
(141, '2018_01_16_203358_add_gift_received', 1),
(142, '2018_01_16_212320_rename_gift_columns', 1),
(
        143,
        '2018_01_17_230820_add_gift_tab_view_to_users',
        1
    ),
(144, '2018_01_27_014146_add_custom_gender', 1),
(145, '2018_02_25_202752_change_locale_in_db', 1),
(
        146,
        '2018_02_28_223747_update_notification_table',
        1
    ),
(
        147,
        '2018_03_03_204440_create_relationship_type_table',
        1
    ),
(
        148,
        '2018_03_18_085815_populate_default_relationship_type_tables',
        1
    ),
(
        149,
        '2018_03_18_090209_populate_relationship_type_tables_with_default_values',
        1
    ),
(
        150,
        '2018_03_18_090345_migrate_current_relationship_table_to_new_relationship_structure',
        1
    ),
(151, '2018_03_24_083258_migrate_offsprings', 1),
(
        152,
        '2018_04_04_220850_create_default_modules_table',
        1
    ),
(
        153,
        '2018_04_04_222608_create_account_modules_table',
        1
    ),
(154, '2018_04_10_205655_fix_production_error', 1),
(155, '2018_04_10_222515_migrate-modules', 1),
(156, '2018_04_13_131008_fix-contacts-data', 1),
(157, '2018_04_13_205231_create_changes_table', 1),
(158, '2018_04_14_081052_fix_wrong_gender', 1),
(159, '2018_04_19_190239_stay_in_touch', 1),
(160, '2018_05_06_061227_external_countries', 1),
(
        161,
        '2018_05_06_194710_delete_reminder_sent_table',
        1
    ),
(162, '2018_05_07_070458_create_terms_table', 1),
(
        163,
        '2018_05_13_110706_add_ex_wife_husband_relationship',
        1
    ),
(
        164,
        '2018_05_16_143631_add_nickname_to_contacts',
        1
    ),
(
        165,
...
(166, '2018_05_20_121028_accept_terms', 1),
(
        167,
        '2018_05_20_225034_change_name_order_user-_preferencies',
        1
    ),
(
        168,
        '2018_05_24_160546_fix-inconsistant-reminder-time',
        1
    ),
(
        169,
        '2018_06_10_191450_add_love_metadata_relationshisp',
        1
    ),
(
        170,
        '2018_06_10_221746_migrate_entries_objects',
        1
    ),
(
        171,
        '2018_06_11_184017_change_default_user_table',
        1
    ),
(172, '2018_06_13_000100_create_u2f_key_table', 1),
(
        173,
        '2018_06_14_212502_change_default_name_order_user_table',
        1
    ),
(
        174,
        '2018_07_03_204220_create_default_activity_type_groups_table',
        1
    ),
(
        175,
        '2018_07_08_104306_update-timestamps-timezone',
        1
    ),
(176, '2018_07_26_104306_create-conversations', 1),
(
        177,
        '2018_08_06_145046_add_starred_to_contacts',
        1
    ),
(178, '2018_08_09_18000_fix-empty-reminder-time', 1),
(179, '2018_08_18_180426_add_legacy_free_plan', 1),
(
        180,
        '2018_08_29_124804_add_conversations_to_statistics',
        1
    ),
(
        181,
        '2018_08_29_222051_add_conversations_to_modules',
        1
    ),
(
        182,
        '2018_08_31_020908_create_life_events_table',
        1
    ),
(183, '2018_09_02_150531_contact_archiving', 1),
(
        184,
        '2018_09_05_025008_add_default_profile_view',
        1
    ),
(185, '2018_09_05_213507_mark_modules_migrated', 1),
(
        186,
        '2018_09_13_135926_add_description_field_to_contacts',
        1
    ),
(187, '2018_09_18_142844_remove_events', 1),
(188, '2018_09_23_024528_add_documents_table', 1),
(
        189,
        '2018_09_29_114125_add_reminder_to_life_events',
        1
    ),
(190, '2018_10_01_211757_add_number_of_views', 1),
(191, '2018_10_04_181116_life_event_vehicle', 1),
(192, '2018_10_07_120133_fix_json_column', 1),
(
        193,
        '2018_10_16_000703_add_documents_to_module_table',
        1
    ),
(194, '2018_10_19_081816_life_event_tattoo', 1),
(
        195,
        '2018_10_27_230346_fix_non_english_tab_slugs',
        1
    ),
(196, '2018_10_28_165814_email_verified', 1),
(
        197,
        '2018_11_11_145035_remove_changelogs_table',
        1
    ),
(
        198,
        '2018_11_15_172333_make_contact_id_nullable_in_tasks',
        1
    ),
(199, '2018_11_18_021908_create_images_table', 1),
(200, '2018_11_21_212932_add_contacts_uuid', 1),
(
        201,
        '2018_11_25_020818_add_contact_photo_table',
        1
    ),
(202, '2018_11_30_154729_recovery_codes', 1),
(
        203,
        '2018_12_08_233140_add_who_called_to_calls',
        1
    ),
(204, '2018_12_09_023232_add_emotions_table', 1),
(
        205,
        '2018_12_09_145956_create_emotion_call_table',
        1
    ),
(
        206,
        '2018_12_16_195440_add_gps_coordinates_to_addressess',
        1
    ),
(207, '2018_12_19_002819_create_places_table', 1),
(208, '2018_12_19_003444_move_addresses_data', 1),
(209, '2018_12_21_235418_add_weather_table', 1),
(
        210,
        '2018_12_22_021123_add_weather_preferences_to_users',
        1
    ),
(
        211,
        '2018_12_22_200413_add_reminder_initial_date_to_reminders',
        1
    ),
(212, '2018_12_24_164256_add_companies_table', 1),
(213, '2018_12_24_220019_add_occupations_table', 1),
(
        214,
        '2018_12_25_001736_add_linkedin_to_default_contact_field_type',
        1
    ),
(
        215,
        '2018_12_25_012011_move_linkedin_data_to_contact_field_type',
        1
    ),
(
        216,
        '2018_12_29_091017_default_temperature_scale',
        1
    ),
(217, '2018_12_29_135516_sync_token', 1),
(
        218,
        '2019_01_05_152329_add_reminder_ids_to_contacts',
        1
    ),
(
        219,
...
(
        220,
        '2019_01_05_152456_drop_special_date_id_from_reminders',
        1
    ),
(221, '2019_01_05_152526_schedule_new_reminders', 1),
(
        222,
        '2019_01_05_202557_add_foreign_keys_to_reminder',
        1
    ),
(
        223,
        '2019_01_05_202748_add_foreign_key_to_reminder_rule',
        1
    ),
(
        224,
        '2019_01_05_202938_add_foreign_key_to_contacts',
        1
    ),
(
        225,
        '2019_01_05_203201_add_foreign_key_for_reminder_in_life-events_table',
        1
    ),
(226, '2019_01_06_135133_update_u2f_key_table', 1),
(
        227,
        '2019_01_06_150143_add_inactive_flag_to_reminders',
        1
    ),
(228, '2019_01_06_190036_u2f_key_name', 1),
(
        229,
        '2019_01_11_142944_add_foreign_keys_to_activities',
        1
    ),
(
        230,
        '2019_01_11_183717_change_activities_date_type',
        1
    ),
(231, '2019_01_17_093812_add_admin_user', 1),
(232, '2019_01_18_142032_add_dav_uuid', 1),
(
        233,
        '2019_01_22_034555_create_emotion_activity_table',
        1
    ),
(
        234,
        '2019_01_24_221539_change_activity_model_location',
        1
    ),
(
        235,
        '2019_01_31_223600_add_swiss_chf_to_currencies_table',
        1
    ),
(
        236,
        '2019_02_08_234959_remove_users_without_account',
        1
    ),
(237, '2019_02_09_200203_add_gender_type', 1),
(238, '2019_02_17_112452_add_default_gender', 1),
(239, '2019_02_20_205744_allow_gender_null', 1),
(
        240,
        '2019_02_24_223855_remove_relation_type_name',
        1
    ),
(
        241,
        '2019_03_27_103012_set_default_profile_links',
        1
    ),
(242, '2019_03_29_163611_add_webauthn', 1),
(243, '2019_05_05_194746_add_cron_schedule', 1),
(244, '2019_05_15_205533_rename_preferences', 1),
(
        245,
        '2019_05_26_000000_add_relationship_table_indexes',
        1
    ),
(
        246,
        '2019_05_27_000000_populate_relationship_type_tables_with_stepparent_values',
        1
    ),
(
        247,
        '2019_08_12_213308_change_avatars_structure',
        1
    ),
(
        248,
        '2019_08_12_222938_create_avatars_for_existing_contacts',
        1
    ),
(249, '2019_08_13_160332_add_me_contact_on_user', 1),
(250, '2019_08_14_091427_update_stripe_columns', 1),
(
        251,
        '2019_09_04_075311_fix_tattoo_or_piercing_translation',
        1
    ),
(252, '2019_12_17_024553_add_foreign_keys', 1),
(253, '2019_12_21_100315_change_gift_status', 1),
(254, '2019_12_21_194559_add_photo_gift', 1),
(255, '2019_12_27_23533_rename_picnicked', 1),
(256, '2020_02_03_015403_create_audit_log_table', 1),
(
        257,
        '2020_02_18_211620_add_contact_field_label',
        1
    ),
(
        258,
        '2020_03_22_132429_rename_birthday_reminder_title_deceased',
        1
    ),
(
        259,
        '2020_04_24_185810_remove_duplicate_currency',
        1
    ),
(260, '2020_04_24_205810_currencies_table_seed', 1),
(261, '2020_04_24_212138_update_amount_format', 1),
(262, '2020_05_08_072433_google2fa_column_size', 1);
...
INSERT INTO
    `pet_categories`
VALUES
    (1, 'reptile', 0, NULL, NULL),
(2, 'bird', 0, NULL, NULL),
(3, 'cat', 1, NULL, NULL),
(4, 'dog', 1, NULL, NULL),
(5, 'fish', 1, NULL, NULL),
(6, 'hamster', 0, NULL, NULL),
(7, 'horse', 0, NULL, NULL),
(8, 'rabbit', 0, NULL, NULL),
(9, 'rat', 0, NULL, NULL),
(10, 'small_animal', 0, NULL, NULL),
(11, 'other', 0, NULL, NULL);
...
CREATE TABLE `reminder_sent` (
    ...
    CONSTRAINT `reminder_sent_reminder_id_foreign` FOREIGN KEY (`reminder_id`) REFERENCES `reminders` (`id`) ON DELETE
    SET
        NULL,
...
CREATE TABLE `users` (
    ...
    CONSTRAINT `users_currency_id_foreign` FOREIGN KEY (`currency_id`) REFERENCES `currencies` (`id`) ON DELETE
    SET
        NULL,
        CONSTRAINT `users_invited_by_user_id_foreign` FOREIGN KEY (`invited_by_user_id`) REFERENCES `users` (`id`) ON DELETE
    SET
        NULL,
        CONSTRAINT `users_me_contact_id_foreign` FOREIGN KEY (`me_contact_id`) REFERENCES `contacts` (`id`) ON DELETE
    SET
        NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
