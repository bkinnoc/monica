...
# touch /etc/supervisor/conf.d/laravel-octane.conf
# cat << 'EOB' > /etc/supervisor/conf.d/laravel-octane.conf
# [program:laravel-octane]
# command=/var/www/html/artisan octane:start --server=swoole --host=0.0.0.0 --port=8000 --max-requests=1000 --watch
# user=root
# autostart=true
# autorestart=true
